		...
		<section class="msg-popup-sec">
            ...
            <div class="bd-container">
                <div class="row">
					...
					<img class="visible_mobile brnd-image" src="assets/images/membership-mob.svg" alt=""><h1>Memberships</h1>
						</div>
                    ...
                    <div class="img-div  brand-icon-img">
                        <span class="msg-img">
                            <img src="assets/images/uploads/membership.svg" alt="">
                        </span>
                    </div>
                </div>
            </div>			
