            ...
            <div class="bd-container">
                <div class="row">
					...
					<div class="page-title ttl-sm">
						<img class="visible_mobile brnd-image" src="assets/images/fixed-desk-mob.svg" alt=""><h1>Fixed Desk</h1>
					</div>
                    ...
                    <div class="img-div  brand-icon-img">
                        <span class="msg-img">
                            <img src="assets/images/uploads/fixeddesk.svg" alt="">
                        </span>
                    </div>
                </div>
            </div>			
				...
				<div class="search-result-top">
					<div class="row d-flx alignVcenter h100">
						<div class="col-lg-8 col-md-8">
							...
							120 Fixed desk spaces in Dubai”
							</div>
						</div>
