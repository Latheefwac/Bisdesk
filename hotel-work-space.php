				...
				<div class="row">
					<div class="msg-div">
						<div class="page-title ttl-sm">
							<h1>Hotel Work Space</h1>
						</div>
						<p>A private office is a space that is separated and out of ear shot from other companies.
							Compared to open offices, private offices offer businesses control over the space, more
							privacy, and a quieter working environment.</p>
						<p>You can find private offices in serviced, leased, and subleased office spaces. These
							workspaces all come with a host of services to meet the needs of your business.</p>
					</div>
					<div class="img-div">
						<span class="msg-img">
							<img src="assets/images/uploads/hotelwork.jpg" alt="">
						</span>
					</div>
				</div>
			</div>
