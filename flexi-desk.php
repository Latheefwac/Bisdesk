            ...
            <div class="bd-container">
                <div class="row">
					...
					<div class="page-title ttl-sm">
						<img class="visible_mobile brnd-image" src="assets/images/flexi-desk-mob.svg" alt=""><h1>Flexi Desk</h1>
						</div>
                    ...
                    <div class="img-div  brand-icon-img">
                        <span class="msg-img">
                            <img src="assets/images/uploads/flexidesk.svg" alt="">
                        </span>
                    </div>
                </div>
            </div>			
					...
					<div class="row d-flx alignVcenter h100">
						<div class="col-lg-8 col-md-8">
							<div class="search-rslt">
								120 Flexi desk spaces in Dubai”
							</div>
						</div>
