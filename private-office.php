...
<main class="site-content page-back innerpages search-result-page explore-bisdesk-page">
	...
	<!-- message popup section -->
		<section class="msg-popup-sec" id="msg-popup-sec">
            <i class="close-msg"></i>
            <div class="bd-container">
                <div class="row">
                    <div class="msg-div">
						<div class="page-title ttl-sm">
							<img class="visible_mobile brnd-image" src="assets/images/private-office-mob.svg" alt=""><h1>Private Office</h1>
						</div>
                    ...
                    <div class="img-div brand-icon-img">
                        <span class="msg-img">
                            <img src="assets/images/uploads/privateffice.svg" alt="">
                        </span>
                    </div>
				</div>
					...
					<div class="row d-flx alignVcenter h100">
						<div class="col-lg-8 col-md-8">
							<div class="search-rslt">
								120 Private office spaces in Dubai”
							</div>
						</div>
